      ...
      <thead>
        <tr
          ...
          className="
           ...
           "
        >
          <th className="px-4 py-6 text-left">SR NO.</th>
          <th className="px-4 py-6 text-left">EMPLOYEE NAME</th>
          <th className="px-4 py-6 text-left">POLICY STATUS</th>
      ...
      <tbody>
        {employees.map((employee) => (
          ...
          >
            ...
            <td
              className="px-4 py-6 font-bold "
            >
              <button className="" style={{ color: "#1658FF",textDecorationLine: "underline" }}>{employee.actions}</button>
            </td>
          </tr>
        ))}
      </tbody>
